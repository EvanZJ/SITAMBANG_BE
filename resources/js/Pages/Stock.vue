    ...
    <div class="container">
        <div class="isi-item" v-for="(stock, idx) in stocks" :key="idx">
            ...
            <div class="d-flex row detail-item justify-content-between">
                <div class="d-flex fix">
                    <div class="row">
                        ...
                        <div class="col">
                            <a :href="'/stock/edit/'+stock.id" class="row button-isi btn btn-primary" v-if="isKaryawan">
                                Edit Stock
                            </a>
                            <form method="POST" :action="'/stock/delete/'+stock.id" v-if="isKaryawan">
            ...
            <div class="tempat-button">
                <a href="/stock/create" type="button" class="btn btn-primary" v-if="isKaryawan">Tambah Produk</a>
            </div>
