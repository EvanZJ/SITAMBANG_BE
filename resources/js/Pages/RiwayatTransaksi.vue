...
const getResults = async (page = 1) => {
    const response = await fetch(`https://127.0.0.1:8000/karyawan/get-pagination?page=${page}`);
                            ...
                            <td>
                                ...
                                <form method="POST" :action="'/karyawan/delete-pemesanan/' + post.id" v-if="isAdmin"> 
                                    ...
                                    <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" v-on:click="" v-if="isAdmin">
                                        <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
