                        ...
                        <tbody>
                          <tr v-for="post in riwayatTransaksi.data" :key="post.id">
                            ...
                            <td>
                                ...
                                <form method="POST" :action="'/karyawan/delete-pemesanan/' + post.id">
                                    <input type="hidden" name="_token" :value="token">
                                    <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" v-on:click="">
